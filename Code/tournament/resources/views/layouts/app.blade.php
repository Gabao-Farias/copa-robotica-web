        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                <ul class="nav navbar-nav">
                    <li{!! Request::is('/') ? ' class="active"' : '' !!}><a href="{{ url('/') }}">Início</a></li>
                    <li{!! Request::is('ringues*') ? ' class="active"' : '' !!}><a href="{{ url('ringues') }}">Ringues</a></li>
                    <li{!! Request::is('ranking') ? ' class="active"' : '' !!}><a href="{{ url('ranking') }}">Ranking</a></li>
                    <li{!! Request::is('chaveamento') ? ' class="active"' : '' !!}><a href="{{ url('chaveamento') }}">Chaveamento</a></li>
                </ul>
