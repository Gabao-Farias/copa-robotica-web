...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'auth'], function() {
    ...
    Route::get('equipes-sem-foto', function() {
        $equipes = App\Equipe::where(['foto_robo_path' => null, 'presente' => 1])->get();

        echo '<strong>Equipes sem foto:</strong><br><br>';
        foreach ($equipes as $equipe)
        {
            echo $equipe->nome . ' | ' . $equipe->escola->nome . '<br><br>';
        }
    });
});
